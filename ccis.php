...
$sql = "SELECT COUNT(*) AS total FROM employees WHERE department = 'CCIS'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$total_ccis = $row['total'];
// Fetch employees where position = 'ccis'
$sql = "SELECT * FROM employees WHERE department = 'ccis'";
$result = $conn->query($sql);
?>
...
<body>
    ...
    <div class="container">
        <h2>College of Computing and Information Sciences Employees List</h2>
        <table>
            <tr>
                <th>Employee ID</th>
                <th>Name</th>
